...
exports.FullDemo = void 0;
const git_repo_1 = require("../../src/lib/utils/git_repo");
const abstract_demo_1 = require("./abstract_demo");
class FullDemo extends abstract_demo_1.AbstractDemo {
    constructor() {
        super('full', [
