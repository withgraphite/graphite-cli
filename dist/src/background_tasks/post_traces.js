...
async function postTelemetry() {
    ...
    if (tracesPath && fs_extra_1.default.existsSync(tracesPath)) {
        ...
        try {
            await retyped_routes_1.request.requestWithArgs(server_1.API_SERVER, graphite_cli_routes_1.API_ROUTES.traces, {
                auth: user_config_1.userConfigFactory.loadIfExists()?.data.authToken,
