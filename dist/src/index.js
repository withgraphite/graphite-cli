...
(0, telemetry_1.fetchUpgradePromptInBackground)();
(0, requests_1.refreshPRInfoInBackground)();
...
(0, post_survey_1.postSurveyResponsesInBackground)();
// https://www.npmjs.com/package/tmp#graceful-cleanup
tmp_1.default.setGracefulCleanup();
process.on('uncaughtException', (err) => {
    (0, telemetry_1.postTelemetryInBackground)({
...
(0, utils_1.signpostDeprecatedCommands)(process.argv[2]);
(0, passthrough_1.passthrough)(process.argv);
(0, utils_1.preprocessCommand)();
