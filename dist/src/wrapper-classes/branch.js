...
class Branch {
    ...
    getChildrenFromMeta(context) {
        ...
        const children = Branch.allBranches(context).filter((b) => { var _a; return ((_a = metadata_ref_1.default.getMeta(b.name)) === null || _a === void 0 ? void 0 : _a.parentBranchName) === this.name; });
