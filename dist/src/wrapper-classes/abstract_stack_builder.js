...
class AbstractStackBuilder {
    ...
    allStackBaseNames(context) {
        utils_1.logDebug(`Getting all branches...`);
        const allBranches = branch_1.Branch.allBranches(context, {
            useMemoizedResults: this.useMemoizedResults,
        });
        utils_1.logDebug(`Got ${allBranches.length} branches`);
        utils_1.logDebug(`Getting all stack base names...`);
        ...
        utils_1.logDebug(`Got ${uniqueStackBaseNames.length} stack base names...`);
    ...
    getStackBaseBranch(branch, opts, context) {
        utils_1.logDebug(`Getting base branch for ${branch.name}...`);
        ...
        if (!parent || ((opts === null || opts === void 0 ? void 0 : opts.excludingTrunk) && parent.isTrunk(context))) {
            utils_1.logDebug(`Base branch is ${branch.name}`);
            return branch;
        }
