...
function getSurvey() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const authToken = (0, preconditions_1.cliAuthPrecondition)();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if ((survey === null || survey === void 0 ? void 0 : survey.introMessage) !== undefined) {
                (0, utils_1.logMessageFromGraphite)(survey.introMessage);
            }
            (0, utils_1.logNewline)();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        for (const [index, question] of args.questions.entries()) {
            ...
            switch (question.type) {
                case 'TEXT':
                    promptResponse = yield (0, prompts_1.default)({
                        type: 'text',
                        name: 'answer',
...
function logAnswers(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, post_survey_1.postSurveyResponse)();
        if (args.completionMessage !== undefined) {
            (0, utils_1.logMessageFromGraphite)(args.completionMessage);
        }
        return;
    });
}
