...
function getBranchChildrenOrParentsFromGit(branch, opts, context) {
    var _a;
    context.splog.logDebug(`Getting ${opts.direction} of ${branch.name} from git...`);
