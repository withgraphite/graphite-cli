...
exports.cliAuthPrecondition = exports.ensureSomeStagedChangesPrecondition = exports.currentGitRepoPrecondition = exports.uncommittedTrackedChangesPrecondition = exports.branchExistsPrecondition = exports.currentBranchPrecondition = void 0;
const branch_1 = require("../wrapper-classes/branch");
const errors_1 = require("./errors");
const branch_exists_1 = require("./utils/branch_exists");
const detect_staged_changes_1 = require("./utils/detect_staged_changes");
...
function ensureSomeStagedChangesPrecondition(context) {
    ...
    if (git_status_utils_1.unstagedChanges()) {
        splog_1.logTip('There are unstaged changes. Use -a option to stage all unstaged changes.', context);
    }
