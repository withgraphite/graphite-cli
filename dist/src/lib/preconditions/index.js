...
function addAllAvailableTip() {
    if ((0, utils_1.unstagedChanges)()) {
        (0, utils_1.logTip)('There are unstaged changes. Use -a option to stage all unstaged changes.');
    }
}
...
function ensureSomeStagedChangesPrecondition(addAllLogTipEnabled) {
    if (!(0, utils_1.detectStagedChanges)()) {
        (0, utils_1.gpExecSync)({ command: `git status`, options: { stdio: 'ignore' } });
...
function currentGitRepoPrecondition() {
    const repoRootPath = (0, utils_1.gpExecSync)({
