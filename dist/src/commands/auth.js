...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(argv, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.token) {
            ...
            (0, utils_1.logSuccess)(`🔐 Saved auth token to "${config_1.userConfig.path()}"`);
            return;
        }
        (0, utils_1.logInfo)((_a = config_1.userConfig.getAuthToken()) !== null && _a !== void 0 ? _a : 'No auth token set.');
    }));
});
