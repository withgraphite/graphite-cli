...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.token) {
            ...
            context.splog.logInfo(chalk_1.default.green(`🔐 Saved auth token to "${context.userConfig.path}"`));
            return;
        }
        context.splog.logInfo((_a = context.userConfig.data.authToken) !== null && _a !== void 0 ? _a : 'No auth token set.');
    }));
});
