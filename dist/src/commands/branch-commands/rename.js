...
const handler = (args) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(args, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const newName = branch_name_1.replaceUnsupportedCharacters(args['new-branch-name'], context);
        const allBranches = branch_1.Branch.allBranches(context);
        if (((_a = currentBranch.getPRInfo()) === null || _a === void 0 ? void 0 : _a.number) && !args.force) {
        ...
        context.splog.logInfo(`Successfully renamed (${oldName}) to (${chalk_1.default.green(newName)})`);
    }));
});
