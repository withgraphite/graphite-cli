...
const handler = (args) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(args, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, utils_1.gpExecSync)({ command: `git branch -m ${newName}` }, (err) => {
        ...
        (0, utils_1.logInfo)(`Successfully renamed (${oldName}) to (${chalk_1.default.green(newName)})`);
    }));
});
