    ...
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.set) {
            ...
            if (parent) {
                ...
                context.splog.logInfo(`Current branch (${branch}) has no parent branch set in Graphite. Consider running \`gt stack fix\`, or \`gt upstack onto <parent>\` to set a parent branch in Graphite.`);
            }
        }
    }));
});
...
function setParent(branch, parent, context) {
    ...
    context.splog.logInfo(`Updated (${branch}) parent from (${oldParent}) to (${chalk_1.default.green(parent)})`);
    return;
}
