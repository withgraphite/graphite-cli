    ...
    return (0, telemetry_1.profile)(argv, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.set) {
            ...
            if (parent) {
                ...
                (0, utils_1.logInfo)(`Current branch (${branch}) has no parent branch set in Graphite. Consider running \`gt stack fix\`, or \`gt upstack onto <parent>\` to set a parent branch in Graphite.`);
            }
        }
    }));
});
