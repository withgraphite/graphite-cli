...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(argv, exports.canoncial, () => __awaiter(void 0, void 0, void 0, function* () {
        const branch = (0, preconditions_1.currentBranchPrecondition)();
        if (argv.reset) {
            branch.clearPRInfo();
            return;
        }
        yield (0, pr_info_1.syncPRInfoForBranches)([branch]);
        const prInfo = branch.getPRInfo();
        if (prInfo === undefined) {
            (0, utils_1.logError)(`Could not find associated PR. Please double-check that a PR exists on GitHub in repo ${chalk_1.default.bold(config_1.repoConfig.getRepoName())} for the branch ${chalk_1.default.bold(branch.name)}.`);
            return;
        }
        console.log((0, print_stack_1.getBranchTitle)(branch, {
            currentBranch: null,
            offTrunk: false,
            visited: [],
        }));
