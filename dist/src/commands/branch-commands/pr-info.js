...
exports.canonical = 'branch pr-info';
...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (prInfo === undefined) {
            context.splog.logError(`Could not find associated PR. Please double-check that a PR exists on GitHub in repo ${chalk_1.default.bold(context.repoConfig.getRepoName())} for the branch ${chalk_1.default.bold(branch.name)}.`);
            return;
        }
