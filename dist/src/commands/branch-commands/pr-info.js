...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return telemetry_1.profile(argv, exports.canoncial, (context) => __awaiter(void 0, void 0, void 0, function* () {
        const branch = preconditions_1.currentBranchPrecondition(context);
        if (argv.reset) {
            branch.clearPRInfo();
            return;
        }
        yield pr_info_1.syncPRInfoForBranchByName(branch, context);
        const prInfo = branch.getPRInfo();
        if (prInfo === undefined) {
            utils_1.logError(`Could not find associated PR. Please double-check that a PR exists on GitHub in repo ${chalk_1.default.bold(context.repoConfig.getRepoName())} for the branch ${chalk_1.default.bold(branch.name)}.`);
            return;
        }
