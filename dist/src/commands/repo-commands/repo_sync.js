...
exports.aliases = ['s'];
exports.description = 'Delete any branches that have been merged or squashed into the trunk branch, and recursively check for stack states against main.';
exports.builder = args;
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(argv, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, sync_1.syncAction)({
            pull: argv.pull,
            force: argv.force,
