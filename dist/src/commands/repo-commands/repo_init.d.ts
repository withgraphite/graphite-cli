...
declare const args: {
    ...
    readonly 'ignore-branches': {
        readonly describe: "A list of branches (or glob patterns) that Graphite should ignore when tracking your stacks (i.e. branches you never intend to merge into trunk).";
        readonly demandOption: false;
        readonly optional: true;
        readonly type: "string";
        readonly array: true;
