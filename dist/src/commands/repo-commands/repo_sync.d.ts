...
declare const args: {
    ...
    readonly 'prune-remote-metadata': {
        readonly describe: "Prune branch metadata on remote not corresponding to a branch.";
        readonly demandOption: false;
        readonly default: true;
        readonly type: "boolean";
    };
...
export declare const description = "Delete any branches that have been merged or squashed into the trunk branch, and recursively check for stack states against main.";
