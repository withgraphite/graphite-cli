...
function branchMetadataSanityChecks(force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((0, fix_dangling_branches_1.existsDanglingBranches)()) {
            ...
            (0, utils_1.logTip)(`To ensure Graphite always has a known parent for your branch, create your branch through Graphite with \`gt branch create <branch_name>\`.`);
            (0, utils_1.logNewline)();
            yield (0, fix_dangling_branches_1.fixDanglingBranches)(force);
            (0, utils_1.logNewline)();
        }
        else {
            (0, utils_1.logInfo)(`All branches well-formed.`);
            (0, utils_1.logNewline)();
        }
    });
}
function branchCountSanityCheck(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (branchCount > 50) {
            ...
            (0, utils_1.logTip)(`To further reduce Graphite's search space, you can also tune the maximum days and/or stacks Graphite tracks behind trunk using \`gt repo max-days-behind-trunk --set\` or \`gt repo max-stacks-behind-trunk --set\`.`);
            (0, utils_1.logNewline)();
        }
        (0, utils_1.logInfo)(`Searching for any stale branches that can be removed...`);
...
function branchCountSanityCheckContinuation(frame) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.logNewline)();
        (0, utils_1.logInfo)(`Still seeing issues with Graphite? Send us feedback via \`gt feedback '<your_issue'> --with-debug-context\` and we'll dig in!`);
    });
}
