...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        if (argv.set) {
            ...
            splog_1.logInfo(`Editor preference set to: ${argv.set}`);
        }
        else if (argv.unset) {
            context.userConfig.update((data) => (data.editor = exports.DEFAULT_GRAPHITE_EDITOR));
            splog_1.logInfo(`Editor preference erased. Defaulting to Graphite default: ${exports.DEFAULT_GRAPHITE_EDITOR}`);
        }
        else {
            if (!context.userConfig.data.editor) {
                default_editor_1.setDefaultEditor(context);
            }
            splog_1.logInfo(`Current editor preference is set to : ${context.userConfig.data.editor}`);
        }
    }));
});
