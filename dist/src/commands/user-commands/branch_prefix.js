...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        if (argv.reset) {
            ...
            context.splog.logInfo(`Set branch-prefix to "${chalk_1.default.green(branch_name_1.setBranchPrefix(argv.set, context))}"`);
        }
        else {
            context.splog.logInfo(context.userConfig.data.branchPrefix ||
