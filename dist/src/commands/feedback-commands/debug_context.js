...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return telemetry_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        if (argv['recreate-from-file']) {
            const dir = debug_context_1.recreateState(fs_extra_1.default.readFileSync(argv['recreate-from-file']).toString(), context);
            utils_1.logInfo(`${chalk_1.default.green(dir)}`);
        }
        else if (argv.recreate) {
            const dir = debug_context_1.recreateState(argv.recreate, context);
            utils_1.logInfo(`${chalk_1.default.green(dir)}`);
        }
        else {
            utils_1.logInfo(debug_context_1.captureState(context));
        }
    }));
});
