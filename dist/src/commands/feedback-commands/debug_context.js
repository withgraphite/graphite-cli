...
const debugContext_1 = require("../../lib/debugContext");
...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        if (argv['recreate-from-file']) {
            const dir = debugContext_1.recreateState(fs_extra_1.default.readFileSync(argv['recreate-from-file']).toString(), context);
            context.splog.logInfo(`${chalk_1.default.green(dir)}`);
        }
        else if (argv.recreate) {
            const dir = debugContext_1.recreateState(argv.recreate, context);
            context.splog.logInfo(`${chalk_1.default.green(dir)}`);
        }
        else {
            context.splog.logInfo(debugContext_1.captureState(context));
        }
    }));
});
