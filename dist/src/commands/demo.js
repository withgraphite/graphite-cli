...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(argv, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        repo.checkoutBranch('main');
        (0, child_process_1.execSync)('git remote add origin git@github.com:screenplaydev/graphite-demo-repo.git', { cwd: tmpDir.name });
        (0, child_process_1.execSync)('git push origin main -f', { cwd: tmpDir.name });
    }));
});
exports.handler = handler;
function execCliCommand(command, opts) {
    (0, child_process_1.execSync)(`gt ${command}`, {
        stdio: 'inherit',
        cwd: opts.fromDir,
    });
}
