...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, telemetry_1.profile)(argv, exports.canonical, () => __awaiter(void 0, void 0, void 0, function* () {
        const mostRecentCheckpoint = (0, merge_conflict_callstack_config_1.getPersistedMergeConflictCallstack)();
        ...
        if ((0, rebase_in_progress_1.rebaseInProgress)()) {
            (0, child_process_1.execSync)(`${argv.edit ? '' : 'GIT_EDITOR=true'} git rebase --continue`, {
                stdio: 'inherit',
            });
        }
        yield resolveCallstack(mostRecentCheckpoint);
        (0, merge_conflict_callstack_config_1.clearPersistedMergeConflictCallstack)();
    }));
});
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (callstack.frame.op) {
            case 'STACK_ONTO_BASE_REBASE_CONTINUATION':
                yield (0, onto_1.stackOntoBaseRebaseContinuation)(callstack.frame, callstack.parent);
                break;
            case 'STACK_ONTO_FIX_CONTINUATION':
                yield (0, onto_1.stackOntoFixContinuation)(callstack.frame);
                break;
            case 'STACK_FIX': {
                const branch = yield branch_1.default.branchWithName(callstack.frame.sourceBranchName);
                yield (0, fix_1.restackBranch)({
                    branch: branch,
            ...
            case 'STACK_FIX_ACTION_CONTINUATION':
                yield (0, fix_1.stackFixActionContinuation)(callstack.frame);
                break;
            ...
            case 'REPO_FIX_BRANCH_COUNT_SANTIY_CHECK_CONTINUATION':
                yield (0, fix_2.branchCountSanityCheckContinuation)(callstack.frame);
                break;
            case 'REPO_SYNC_CONTINUATION':
                yield (0, sync_1.repoSyncDeleteMergedBranchesContinuation)(callstack.frame);
                break;
            default:
