...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    return profile_1.profile(argv, exports.canonical, (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (pendingRebase) {
            child_process_1.execSync(`${edit ? '' : 'GIT_EDITOR=true'} git rebase --continue`, {
                stdio: 'inherit',
            });
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (frame.op) {
            ...
            case 'STACK_ONTO_FIX_CONTINUATION':
                stack_onto_1.stackOntoFixContinuation(frame);
                break;
            case 'STACK_FIX': {
                const branch = branch_1.Branch.branchWithName(frame.sourceBranchName, context);
                fix_1.restackBranch({
                    branch: branch,
