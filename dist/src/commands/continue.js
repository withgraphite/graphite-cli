    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (callstack.frame.op) {
            case 'STACK_ONTO_BASE_REBASE_CONTINUATION':
                yield stack_onto_1.stackOntoBaseRebaseContinuation(callstack.frame, callstack.parent);
                break;
            ...
            case 'STACK_EDIT_CONTINUATION':
                yield edit_downstack_1.applyStackEdits(callstack.frame.remainingEdits);
                break;
            default:
