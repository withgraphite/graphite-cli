...
exports.aliases = ['t'];
exports.description = 'Run the provided command on each branch in the current stack and aggregate the results.';
exports.builder = args;
const handler = async (argv) => (0, runner_1.graphite)(argv, exports.canonical, async (context) => (0, test_1.testStack)({ scope: scope_spec_1.SCOPE.STACK, includeTrunk: argv.trunk, command: argv.command }, context));
