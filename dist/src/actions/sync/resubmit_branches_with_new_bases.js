...
const submit_action_1 = require("../submit/submit_action");
function resubmitBranchesWithNewBases(force, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const needsResubmission = [];
        branch_1.Branch.allBranches(context, {
            filter: (b) => {
                var _a;
        ...
        splog_1.logTip(`Disable this check at any point in the future with --no-resubmit`, context);
        ...
        if (resubmit) {
            splog_1.logInfo(`Updating PR to propagate local rebase changes...`);
