...
function pruneRemoteBranchMetadata(context, force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const branchesNeedingPruning = exec_sync_1.gpExecSync({
            ...
            .filter((remoteBranchPath) => exec_sync_1.gpExecSync({
        ...
        splog_1.logInfo(`Remote ${remote} has Graphite metadata for the following branch${hasMultipleBranches ? 'es that no longer exist' : ' that no longer exists'}:`);
        branchesNeedingPruning.forEach((branchName) => splog_1.logInfo(`▸ ${chalk_1.default.yellow(branchName)}`));
        if (!force &&
        ...
        splog_1.logInfo(`Pruning remote metadata...`);
