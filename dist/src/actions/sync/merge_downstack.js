...
const copy_from_remote_1 = require("../../lib/git/copy_from_remote");
...
function mergeDownstack(downstack, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (overwrittenBranches.length) {
            context.splog.logWarn(`'downstack sync' is still in development and does not yet support merging local changes.`);
            context.splog.logWarn(`The following branches' histories will be overwritten if you continue:\n${overwrittenBranches.join('\n')}`);
        ...
        for (const branchName of downstack) {
            ...
            context.splog.logInfo(`${chalk_1.default.green(branchName)} synced from ${context.repoConfig.getRemote()}`);
            parent = branchName;
        }
