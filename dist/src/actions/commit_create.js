...
function commitCreateAction(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, preconditions_1.ensureSomeStagedChangesPrecondition)();
        ...
        try {
            ...
            yield (0, fix_1.fixAction)({
                action: 'rebase',
                mergeConflictCallstack: 'TOP_OF_CALLSTACK_WITH_NOTHING_AFTER',
            });
        }
        catch (_a) {
            (0, utils_1.logWarn)('Cannot fix upstack automatically, some uncommitted changes remain. Please commit or stash, and then `gt stack fix --rebase`');
        }
    });
}
