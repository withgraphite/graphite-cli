...
function getDownstackBranch(currentBranch, direction, context, numSteps) {
    ...
    if (direction === TraversalDirection.Previous &&
        (prevBranch === null || prevBranch === void 0 ? void 0 : prevBranch.isTrunk(context))) {
        branch = prevBranch;
        indent++;
    }
        ...
        while (branch && candidates.length) {
            if (candidates.length === 1) {
                ...
                if (interactive) {
                    ...
                    branch = yield branch_1.default.branchWithName(stack_base_branch, context);
                }
                else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (direction) {
            ...
            case TraversalDirection.Previous: {
                nextBranch = getDownstackBranch(currentBranch, TraversalDirection.Previous, context, opts.numSteps);
                break;
            }
            ...
            case TraversalDirection.Next: {
                nextBranch = yield getUpstackBranch(currentBranch, opts.interactive, TraversalDirection.Next, context, opts.numSteps);
                break;
            }
        }
        if (nextBranch && nextBranch != currentBranch.name) {
            ...
            utils_1.logInfo(`Already at the ${direction === TraversalDirection.Previous ||
