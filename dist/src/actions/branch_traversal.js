...
function getDownstackBranch(currentBranch, direction, context, numSteps) {
    ...
    context.splog.logInfo(`${'  '.repeat(indent)}↳(${chalk_1.default.cyan(branch)})`);
        ...
        while (branch && candidates.length) {
            if (candidates.length === 1) {
                ...
                if (interactive) {
                    ...
                    branch = branch_1.Branch.branchWithName(stack_base_branch);
                }
                else {
...
function switchBranchAction(direction, opts, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (nextBranch && nextBranch != currentBranch.name) {
            ...
            context.splog.logInfo(`Already at the ${direction === TraversalDirection.Down ||
