...
function getDownstackBranch(currentBranch, direction, numSteps) {
    ...
    while (prevBranch && !prevBranch.isTrunk()) {
        (0, utils_1.logInfo)(`${'  '.repeat(indent)}↳(${branch})`);
        branch = prevBranch;
    ...
    (0, utils_1.logInfo)(`${'  '.repeat(indent)}↳(${chalk_1.default.cyan(branch)})`);
...
function switchBranchAction(direction, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (nextBranch && nextBranch != currentBranch.name) {
            (0, child_process_1.execSync)(`git checkout "${nextBranch}"`, { stdio: 'ignore' });
            (0, utils_1.logInfo)(`Switched to ${nextBranch}`);
        }
        else {
            (0, utils_1.logInfo)(`Already at the ${direction === TraversalDirection.Previous ||
