...
function submitAction(args, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!exec_state_config_1.execStateConfig.interactive()) {
            ...
            utils_1.logInfo(`Running in non-interactive mode. Inline prompts to fill PR fields will be skipped${args.draftToggle === undefined
        ...
        // Step 5: Metadata
        yield push_metadata_1.pushMetadata(branchesPushedToRemote, context);
...
function shouldAbort(dryRun, confirm) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (exec_state_config_1.execStateConfig.interactive() &&
            ...
            utils_1.logInfo(chalk_1.default.blueBright('🛑 Aborted submit.'));
            return true;
        }
        return false;
    });
