...
exports.detectEmptyBranches = exports.submitAction = void 0;
...
function submitAction(args, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_1.logInfo(chalk_1.default.blueBright(`➡️ [Step 5] Pushing stack metadata to GitHub...`));
        yield pushMetaStacks(branchesPushedToRemote);
        utils_1.logNewline();
...
function getValidBranchesToSubmit(scope, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const submittableBranches = branchesToSubmit.filter((b) => { var _a, _b; return ((_a = b.getPRInfo()) === null || _a === void 0 ? void 0 : _a.state) !== 'CLOSED' || ((_b = b.getPRInfo()) === null || _b === void 0 ? void 0 : _b.state) !== 'MERGED'; });
        const result = (yield processBranchesInInvalidState(closedBranches, mergedBranches)) ===
            'ABORT' ||
            (yield detectEmptyBranches(submittableBranches, context)) === 'ABORT'
            ? 'ABORT'
            : 'SUCCESS';
        return { result, submittableBranches };
    });
}
function processBranchesInInvalidState(closedBranches, mergedBranches) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_1.logWarn(`PR${hasMultipleBranches ? 's' : ''} for the following branch${hasMultipleBranches ? 'es have' : ' has'} been closed or merged:`);
        ...
        const response = yield prompts_1.default({
            ...
            choices: [
                ...
                {
                    title: `Continue with closed branch${hasMultipleBranches ? 'es' : ''} (best effort)`,
...
function detectEmptyBranches(submittableBranches, context) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.detectEmptyBranches = detectEmptyBranches;
...
function pushMetaStacks(branchesPushedToRemote) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!branchesPushedToRemote.length) {
            utils_1.logInfo(`No eligible branches to push stack metadata for.`);
            return;
        }
        branchesPushedToRemote.forEach((branch) => {
            utils_1.logInfo(`Pushing stack metadata for ${branch.name} to remote...`);
            utils_1.gpExecSync({
