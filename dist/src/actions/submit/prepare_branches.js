...
function getPRInfoForBranches(args, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        context.splog.logInfo(chalk_1.default.blueBright('🥞 Preparing to submit PRs for the following branches...'));
            ...
            : detect_unsubmitted_changes_1.detectUnsubmittedChanges(args.branch)
                ...
                : args.draftToggle === undefined
                    ...
                    : args.draftToggle
                        ? 'DRAFT'
                        : 'PUBLISH';
    context.splog.logInfo(`▸ ${chalk_1.default.cyan(args.branch.name)} (${{
        CREATE: 'Create',
...
function getPRCreationInfo(args, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (context.interactive) {
            context.splog.logNewline();
            context.splog.logInfo(`Enter info for new pull request for ${chalk_1.default.yellow(args.branch.name)} ▸ ${args.parentBranchName}:`);
        }
        const submitInfo = {};
        try {
            submitInfo.title = yield pr_title_1.getPRTitle({
                branch: args.branch,
                editPRFieldsInline: args.editPRFieldsInline,
            }, context);
            submitInfo.body = yield pr_body_1.getPRBody({
                branch: args.branch,
                editPRFieldsInline: args.editPRFieldsInline,
            }, context);
        }
        ...
        const createAsDraft = (_a = args.draftToggle) !== null && _a !== void 0 ? _a : (yield pr_draft_1.getPRDraftStatus(context));
        return {
