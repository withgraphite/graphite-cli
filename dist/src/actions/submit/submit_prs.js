...
function handlePRReponse(pr, context) {
    ...
    branch_1.Branch.branchWithName(pr.response.head, context).upsertPRInfo(Object.assign(Object.assign({ number: pr.response.prNumber, url: pr.response.prURL, base: pr.request.base, state: 'OPEN' }, (pr.request.action === 'create'
        ? {
