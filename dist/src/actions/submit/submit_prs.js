...
function submitPullRequest(args, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const { errorMessage } = handlePRReponse((yield requestServerToSubmitPRs(args.cliAuthToken, [args.submissionInfoWithBranch], context))[0]);
        if (errorMessage) {
