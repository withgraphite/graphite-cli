...
function getPRBody(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const template = yield (0, pr_templates_1.getPRTemplate)();
        ...
        if (args.editPRFieldsInline) {
            const defaultEditor = yield (0, default_editor_1.getDefaultEditorOrPrompt)();
...
function editPRBody(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, child_process_1.execSync)(`${args.editor} ${file.name}`, { stdio: 'inherit' });
...
function inferPRBody(branch) {
    ...
    const singleCommit = (0, utils_1.getSingleCommitOnBranch)(branch);
