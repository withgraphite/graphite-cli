...
function inferPRBody(branch, context) {
    var _a, _b;
    const priorSubmitBody = (_a = branch.getPRInfo()) === null || _a === void 0 ? void 0 : _a.body;
    if (priorSubmitBody !== undefined) {
        return priorSubmitBody;
    }
    // Only infer the title from the commit if the branch has just 1 commit.
    const singleCommitBody = (_b = single_commit_1.getSingleCommitOnBranch(branch, context)) === null || _b === void 0 ? void 0 : _b.messageBody().trim();
