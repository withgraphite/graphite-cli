...
function syncAction(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        if ((0, utils_1.trackedUncommittedChanges)()) {
        ...
        if (opts.pull) {
            ...
            (0, utils_1.logTip)(`Disable this behavior at any point in the future with --no-pull`);
        ...
        if (opts.fixDanglingBranches) {
            ...
            (0, utils_1.logTip)(`Disable this behavior at any point in the future with --no-show-dangling`);
        ...
        if (opts.delete) {
            ...
            (0, utils_1.logTip)(`Disable this behavior at any point in the future with --no-delete`);
...
function resubmitBranchesWithNewBases(force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, utils_1.logTip)(`Disable this check at any point in the future with --no-resubmit`);
