...
function syncAction(opts, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (opts.pull) {
            ...
            utils_1.logTip(`Disable this behavior at any point in the future with --no-pull`);
        ...
        yield pr_info_1.syncPRInfoForBranches(branch_1.default.allBranches(context), context);
        ...
        if (opts.fixDanglingBranches) {
            ...
            utils_1.logTip(`Disable this behavior at any point in the future with --no-show-dangling`);
        ...
        if (opts.delete) {
            ...
            utils_1.logTip(`Disable this behavior at any point in the future with --no-delete`);
...
function resubmitBranchesWithNewBases(force, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_1.logTip(`Disable this check at any point in the future with --no-resubmit`);
