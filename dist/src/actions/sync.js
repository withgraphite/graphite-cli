...
function syncAction(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        if ((0, utils_1.uncommittedChanges)()) {
            throw new errors_1.PreconditionsFailedError('Cannot sync with uncommitted changes');
        }
        const oldBranch = (0, preconditions_1.currentBranchPrecondition)();
        const trunk = (0, utils_1.getTrunk)().name;
        (0, utils_1.checkoutBranch)(trunk);
        if (opts.pull) {
            (0, splog_1.logNewline)();
            (0, utils_1.logInfo)(`Pulling in new changes...`);
            (0, splog_1.logTip)(`Disable this behavior at any point in the future with --no-pull`);
            (0, utils_1.gpExecSync)({ command: `git pull --prune` }, (err) => {
                (0, utils_1.checkoutBranch)(oldBranch.name);
                throw new errors_1.ExitFailedError(`Failed to pull trunk ${trunk}`, err);
            });
        }
        yield (0, pr_info_1.syncPRInfoForBranches)(branch_1.default.allBranches());
        ...
        if (opts.fixDanglingBranches) {
            (0, splog_1.logNewline)();
            (0, utils_1.logInfo)(`Ensuring tracked branches in Graphite are all well-formed...`);
            (0, splog_1.logTip)(`Disable this behavior at any point in the future with --no-show-dangling`);
            yield (0, fix_dangling_branches_1.fixDanglingBranches)(opts.force);
        }
        ...
        if (opts.delete) {
            (0, splog_1.logNewline)();
            (0, utils_1.logInfo)(`Checking if any branches have been merged and can be deleted...`);
            (0, splog_1.logTip)(`Disable this behavior at any point in the future with --no-delete`);
            yield (0, clean_branches_1.deleteMergedBranches)({
                frame: {
...
function repoSyncDeleteMergedBranchesContinuation(frame) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const trunk = (0, utils_1.getTrunk)().name;
        (0, utils_1.checkoutBranch)(branch_1.default.exists(frame.oldBranchName) ? frame.oldBranchName : trunk);
    });
}
...
function resubmitBranchesWithNewBases(force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, splog_1.logTip)(`Disable this check at any point in the future with --no-resubmit`);
        ...
        if (resubmit) {
            (0, utils_1.logInfo)(`Updating PR to propagate local rebase changes...`);
            ...
            yield (0, submit_1.submitBranches)({
