...
function printConflictStatus(errMessage, context) {
    ...
    context.splog.info((0, merge_conflict_help_1.getUnmergedFiles)()
        ...
        .join('\n'));
    context.splog.newline();
    context.splog.info(chalk_1.default.yellow(`You are here:`));
    try {
        (0, log_1.logAction)({ style: 'SHORT', reverse: false, branchName: (0, merge_conflict_help_1.getRebaseHead)(), steps: 3 }, context);
        context.splog.newline();
    }
    catch {
