...
function deleteMergedBranches(opts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const trunkChildren = (0, utils_1.getTrunk)().getChildrenFromMeta();
        /**
        ...
        do {
            ...
            if (opts.frame.showDeleteProgress &&
                ...
                (0, utils_1.logInfo)(`${trunkChildrenProgressMarkers[branch.name]} done searching for merged branches to delete...`);
            }
            ...
            if (shouldDelete) {
                ...
                if (parentName !== undefined && parentName in branchesToDelete) {
                    (0, utils_1.checkoutBranch)(branch.name);
                    (0, utils_1.logInfo)(`upstacking (${branch.name}) onto (${(0, utils_1.getTrunk)().name})`);
                    yield (0, onto_1.ontoAction)({
                        onto: (0, utils_1.getTrunk)().name,
            ...
            (0, utils_1.checkoutBranch)((0, utils_1.getTrunk)().name);
...
function shouldDeleteBranch(args) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mergedBase = githubMergedBase !== null && githubMergedBase !== void 0 ? githubMergedBase : (0, utils_1.getTrunk)().name;
...
function branchMerged(branch) {
    ...
    const cherryCheckProvesMerged = (0, child_process_1.execSync)(`mergeBase=$(git merge-base ${trunk} ${branchName}) && git cherry ${trunk} $(git commit-tree $(git rev-parse "${branchName}^{tree}") -p $mergeBase -m _)`)
        .toString()
        .trim()
        .startsWith('-');
    ...
    const diffCheckProvesMerged = (0, child_process_1.execSync)(`git diff ${branchName} ${trunk} | wc -l`).toString().trim() ===
        '0';
...
function deleteBranch(branch) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.logInfo)(`Deleting (${chalk_1.default.red(branch.name)})`);
        yield (0, delete_branch_1.deleteBranchAction)({
