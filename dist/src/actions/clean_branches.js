...
function cleanBranches(opts, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        context.splog.logInfo(`Checking if any branches have been merged/closed and can be deleted...`);
        if (opts.showSyncTip) {
            context.splog.logTip(`Disable this behavior at any point in the future with --no-delete`);
        }
        ...
        do {
            ...
            if (opts.frame.showDeleteProgress &&
                ...
                context.splog.logInfo(`${trunkChildrenProgressMarkers[branch.name]} done searching for merged/closed branches to delete...`);
            }
            ...
            if (shouldDelete) {
                ...
                if (parentName !== undefined && parentName in branchesToDelete) {
                    ...
                    context.splog.logInfo(`Stacking (${branch.name}) onto (${trunk_1.getTrunk(context).name})...`);
...
function mergedBaseIfMerged(branch, context) {
    ...
    return ((_a = branch.getPRInfo()) === null || _a === void 0 ? void 0 : _a.state) === 'MERGED'
        ? (_c = (_b = branch.getPRInfo()) === null || _b === void 0 ? void 0 : _b.base) !== null && _c !== void 0 ? _c : trunkName
        : is_merged_1.isMerged({ branchName: branch.name, trunkName })
            ? trunkName
            : undefined;
}
exports.mergedBaseIfMerged = mergedBaseIfMerged;
function deleteBranch(branch, context) {
    context.splog.logInfo(`Deleting (${chalk_1.default.red(branch.name)})`);
