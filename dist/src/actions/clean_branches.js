...
function deleteMergedBranches(opts, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        splog_1.logInfo(`Checking if any branches have been merged and can be deleted...`);
        if (opts.showSyncTip) {
        ...
        do {
            ...
            if (opts.frame.showDeleteProgress &&
                ...
                splog_1.logInfo(`${trunkChildrenProgressMarkers[branch.name]} done searching for merged branches to delete...`);
            }
...
function shouldDeleteBranch(args, context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mergedBase = githubMergedBase !== null && githubMergedBase !== void 0 ? githubMergedBase : trunk_1.getTrunk(context).name;
