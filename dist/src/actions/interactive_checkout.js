...
function interactiveCheckout() {
    return __awaiter(this, void 0, void 0, function* () {
        const stack = new wrapper_classes_1.MetaStackBuilder().fullStackFromBranch((0, utils_1.getTrunk)());
...
function promptBranches(choices) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const chosenBranch = (yield (0, prompts_1.default)(Object.assign({ type: 'select', name: 'branch', message: `Checkout a branch`, choices: choices }, (currentBranchIndex ? { initial: currentBranchIndex } : {})), {
            onCancel: () => {
                return;
            },
        })).branch;
        ...
        if (chosenBranch && chosenBranch !== (currentBranch === null || currentBranch === void 0 ? void 0 : currentBranch.name)) {
            (0, utils_1.gpExecSync)({ command: `git checkout ${chosenBranch}` }, (err) => {
