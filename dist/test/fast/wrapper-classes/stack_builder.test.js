...
for (const scene of scenes_1.allScenes) {
    ...
    describe(`(${scene}): stack builder class`, function () {
        ...
        it('Can print stacks from git', () => {
            ...
            (0, chai_1.expect)(gitStacks[0].equals(wrapper_classes_1.Stack.fromMap({ main: { d: {}, a: { b: { c: {} } } } }))).to.be.true;
            // Expect default meta to be 4 stacks of 1 off main.
            (0, chai_1.expect)(metaStacks[0].equals(wrapper_classes_1.Stack.fromMap({ main: { a: {} } })));
            (0, chai_1.expect)(metaStacks[1].equals(wrapper_classes_1.Stack.fromMap({ main: { b: {} } })));
            (0, chai_1.expect)(metaStacks[2].equals(wrapper_classes_1.Stack.fromMap({ main: { c: {} } })));
            (0, chai_1.expect)(metaStacks[3].equals(wrapper_classes_1.Stack.fromMap({ main: { d: {} } })));
        });
        it('Can print stacks from meta', () => {
            ...
            const metaStacks = new wrapper_classes_1.MetaStackBuilder().allStacks();
            const gitStacks = new wrapper_classes_1.GitStackBuilder().allStacks();
            (0, chai_1.expect)(metaStacks[0].equals(wrapper_classes_1.Stack.fromMap({ main: { d: {}, a: { b: {} } } }))).to.be.true;
            // Expect git and meta stacks to equal
            (0, chai_1.expect)(gitStacks[0].equals(metaStacks[0])).to.be.true;
        });
        it('Can get full stack from a branch', () => {
            ...
            (0, chai_1.expect)(metaStack.equals(wrapper_classes_1.Stack.fromMap({ main: { a: { b: {} } } }))).to.be
                .true;
            (0, chai_1.expect)(metaStack.equals(gitStack)).to.be.true;
        });
        it('Can get full stack from trunk', () => {
            ...
            (0, chai_1.expect)(metaStack.equals(wrapper_classes_1.Stack.fromMap({ main: { a: { b: {} }, d: {} } })))
                .to.be.true;
            (0, chai_1.expect)(gitStack.equals(metaStack)).to.be.true;
        });
        it('Can find different git and meta stacks', () => {
            ...
            const metaStack = new wrapper_classes_1.MetaStackBuilder().fullStackFromBranch(new branch_1.default('a'));
            const gitStack = new wrapper_classes_1.GitStackBuilder().fullStackFromBranch(new branch_1.default('a'));
            (0, chai_1.expect)(metaStack.equals(wrapper_classes_1.Stack.fromMap({ main: { a: {} } }))).to.be.true;
            (0, chai_1.expect)(gitStack.equals(wrapper_classes_1.Stack.fromMap({ a: {} }))).to.be.true;
        });
        it('Throws an error if two git branches point to the same commit', () => {
            scene.repo.createChange('a');
            scene.repo.execCliCommand(`branch create "a" -m "a" -q`);
            (0, chai_1.expect)(() => new wrapper_classes_1.GitStackBuilder().fullStackFromBranch(new branch_1.default('a'))).to.not.throw(Error);
            scene.repo.execCliCommand(`branch create "b" -q`);
            (0, chai_1.expect)(() => new wrapper_classes_1.GitStackBuilder().fullStackFromBranch(new branch_1.default('a'))).to.throw(errors_1.SiblingBranchError);
        });
        ...
        it('Merge logic is consistent between git and meta', () => {
            ...
            const metaStack = new wrapper_classes_1.MetaStackBuilder().fullStackFromBranch(new branch_1.default('a'));
            const gitStack = new wrapper_classes_1.GitStackBuilder().fullStackFromBranch(new branch_1.default('a'));
            (0, chai_1.expect)(metaStack.equals(wrapper_classes_1.Stack.fromMap({ main: { a: { b: {}, c: {} } } })))
                .to.be.true;
            (0, chai_1.expect)(metaStack.equals(gitStack)).to.be.true;
        });
    });
