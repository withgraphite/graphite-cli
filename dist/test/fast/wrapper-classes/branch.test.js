...
for (const scene of scenes_1.allScenes) {
    describe(`(${scene}): branch class`, function () {
        ...
        it('Can list git parent for a branch', () => {
            ...
            (0, chai_1.expect)(branch.getParentsFromGit()[0].name).to.equal('main');
        });
        it('Can list parent based on meta for a branch', () => {
            ...
            const branch = new branch_1.default('a');
            (0, chai_1.expect)(branch.getParentFromMeta()).is.not.undefined;
            (0, chai_1.expect)((_a = branch.getParentFromMeta()) === null || _a === void 0 ? void 0 : _a.name).to.equal('main');
        });
        it('Can fetch branches that point to the same commit', () => {
            ...
            (0, chai_1.expect)(new branch_1.default('a')
