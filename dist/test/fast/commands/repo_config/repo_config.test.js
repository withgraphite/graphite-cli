...
for (const scene of [new basic_scene_1.BasicScene()]) {
    describe(`(${scene}): infer repo owner/name`, function () {
        ...
        it('Can infer cloned repos', () => {
            const { owner, name } = (0, repo_config_1.getOwnerAndNameFromURL)('https://github.com/withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        it('Can infer SSH cloned repos', () => {
            const { owner, name } = (0, repo_config_1.getOwnerAndNameFromURL)('git@github.com:withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        it('Can infer SSH cloned repos (with git@ configured separately)', () => {
            const { owner, name } = (0, repo_config_1.getOwnerAndNameFromURL)('github.com/withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        ...
        it('Can infer cloned repos without .git', () => {
            const clone = (0, repo_config_1.getOwnerAndNameFromURL)('https://github.com/withgraphite/graphite-cli');
            (0, chai_1.expect)(clone.owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(clone.name === 'graphite-cli').to.be.true;
            const sshClone = (0, repo_config_1.getOwnerAndNameFromURL)('git@github.com:withgraphite/graphite-cli');
