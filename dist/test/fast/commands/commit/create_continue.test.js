...
for (const scene of all_scenes_1.allScenes) {
    describe(`(${scene}): commit create continue`, function () {
        ...
        it('Can continue a commit create with single merge conflict', () => {
            ...
            (0, chai_1.expect)(() => scene.repo.execCliCommand("commit create -m 'c' -q")).to.throw();
            ...
            (0, expect_commits_1.expectCommits)(scene.repo, 'c, a, 1');
        ...
        it('Can run continue multiple times on a commit create with multiple merge conflicts', () => {
            ...
            (0, chai_1.expect)(() => scene.repo.execCliCommand("commit create -m 'a12' -q")).to.throw();
            (0, chai_1.expect)(scene.repo.rebaseInProgress()).to.be.true;
            scene.repo.resolveMergeConflicts();
            scene.repo.markMergeConflictsAsResolved();
            ...
            // should not be lost.
            (0, chai_1.expect)(scene.repo.currentBranchName()).to.equal('a');
            (0, expect_commits_1.expectCommits)(scene.repo, 'a12, a, 1');
            (0, chai_1.expect)(scene.repo.rebaseInProgress()).to.be.false;
            scene.repo.checkoutBranch('c');
            (0, expect_commits_1.expectCommits)(scene.repo, 'c, b, a12, a');
        });
    });
}
