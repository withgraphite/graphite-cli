...
for (const scene of scenes_1.allScenes) {
    describe(`(${scene}): branch delete`, function () {
        ...
        it('Can run branch delete', () => {
            ...
            (0, chai_1.expect)(branch_1.default.exists(branchName)).to.be.false;
            (0, chai_1.expect)(wrapper_classes_1.MetadataRef.allMetadataRefs().find((ref) => ref._branchName === branchName)).to.be.undefined;
        });
