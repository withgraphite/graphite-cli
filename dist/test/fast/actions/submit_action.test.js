...
const submit_2 = require("../../../src/actions/submit/submit");
...
for (const scene of [new scenes_1.BasicScene()]) {
    describe(`(${scene}): correctly infers submit info from commits`, function () {
        ...
        it('aborts if the branch is empty', () => __awaiter(this, void 0, void 0, function* () {
            ...
            scene.repo.execCliCommand(`branch create "a" -m "a" -q`);
            const branch = yield branch_1.Branch.branchWithName('a', scene.context);
            chai_1.expect(yield submit_2.detectEmptyBranches([branch], scene.context)).to.equals('ABORT');
        }));
        it('does not abort if the branch is not empty', () => __awaiter(this, void 0, void 0, function* () {
            ...
            scene.repo.execCliCommand(`branch create "a" -m "a" -q`);
            const branch = yield branch_1.Branch.branchWithName('a', scene.context);
            chai_1.expect(yield submit_2.detectEmptyBranches([branch], scene.context)).to.equals('SUCCESS');
        }));
    });
}
