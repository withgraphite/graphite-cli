...
for (const scene of [new basic_scene_1.BasicScene()]) {
    describe(`(${scene}): correctly infers submit info from commits`, function () {
        ...
        it('can infer title/body from single commit', () => __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.expect(pr_title_1.inferPRTitle(branch, scene.context)).to.equals(title);
            chai_1.expect(pr_body_1.inferPRBody(branch, scene.context)).to.equals(body);
        }));
        it('can infer just title with no body', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const branch = branch_1.Branch.branchWithName('a');
            chai_1.expect(pr_title_1.inferPRTitle(branch, scene.context)).to.equals(title);
            chai_1.expect(pr_body_1.inferPRBody(branch, scene.context)).to.be.undefined;
        }));
        it('does not infer title/body for multiple commits', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const branch = branch_1.Branch.branchWithName('a');
            chai_1.expect(pr_title_1.inferPRTitle(branch, scene.context)).to.not.equals(title);
            chai_1.expect(pr_body_1.inferPRBody(branch, scene.context)).to.be.undefined;
        }));
        it('aborts if the branch is empty', () => __awaiter(this, void 0, void 0, function* () {
            scene.repo.execCliCommand(`branch create "a" -m "a" -q`);
            const branch = branch_1.Branch.branchWithName('a');
            chai_1.expect(yield validate_branches_1.checkForEmptyBranches([branch], context_1.initContext({ globalArguments: { interactive: false } }))).to.be.empty;
        }));
        it('does not abort if the branch is not empty', () => __awaiter(this, void 0, void 0, function* () {
            scene.repo.createChange('a');
            scene.repo.execCliCommand(`branch create "a" -m "a" -q`);
            const branch = branch_1.Branch.branchWithName('a');
            chai_1.expect((yield validate_branches_1.checkForEmptyBranches([branch], context_1.initContext({ globalArguments: { interactive: false } })))[0].name).to.equals('a');
        }));
    });
}
