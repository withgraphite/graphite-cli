...
for (const scene of scenes_1.allScenes) {
    describe(`(${scene}): validate action`, function () {
        ...
        it('Can validate upstack', () => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(() => (0, validate_1.validate)('UPSTACK')).to.throw(Error);
            scene.repo.checkoutBranch('b');
            (0, chai_1.expect)(() => (0, validate_1.validate)('UPSTACK')).to.not.throw(Error);
        ...
        it('Can validate downstack', () => __awaiter(this, void 0, void 0, function* () {
            ...
            scene.repo.execCliCommand(`branch create "d" -m "d" -q`);
            scene.repo.checkoutBranch('a');
            (0, chai_1.expect)(() => (0, validate_1.validate)('DOWNSTACK')).to.not.throw(Error);
            scene.repo.checkoutBranch('b');
            (0, chai_1.expect)(() => (0, validate_1.validate)('DOWNSTACK')).to.throw(Error);
            scene.repo.checkoutBranch('c');
            (0, chai_1.expect)(() => (0, validate_1.validate)('DOWNSTACK')).to.throw(Error);
            scene.repo.checkoutBranch('d');
            (0, chai_1.expect)(() => (0, validate_1.validate)('DOWNSTACK')).to.throw(Error);
        ...
        it('Can validate fullstack', () => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(() => (0, validate_1.validate)('FULLSTACK')).to.not.throw(Error);
            ...
            config_1.cache.clearAll();
            (0, chai_1.expect)(() => (0, validate_1.validate)('FULLSTACK')).to.throw(Error);
        }));
    });
}
