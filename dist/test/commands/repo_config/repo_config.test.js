...
const repo_config_spf_1 = require("../../../src/lib/spiffy/repo_config_spf");
...
for (const scene of [new basic_scene_1.BasicScene()]) {
    describe(`(${scene}): infer repo owner/name`, function () {
        ...
        it('Can infer cloned repos', () => {
            const { owner, name } = (0, repo_config_spf_1.getOwnerAndNameFromURL)('https://github.com/withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        it('Can infer SSH cloned repos', () => {
            const { owner, name } = (0, repo_config_spf_1.getOwnerAndNameFromURL)('git@github.com:withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        it('Can infer SSH cloned repos (with git@ configured separately)', () => {
            const { owner, name } = (0, repo_config_spf_1.getOwnerAndNameFromURL)('github.com/withgraphite/graphite-cli.git');
            (0, chai_1.expect)(owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(name === 'graphite-cli').to.be.true;
        });
        it('Can read the existing repo config when executing from a subfolder in the project', () => {
            ...
            (0, chai_1.expect)(() => scene.repo.execCliCommand(`ls`, { cwd: subDir })).to.not.throw(Error);
        });
        // Not sure where these are coming from but we should be able to handle
        // them.
        it('Can infer cloned repos without .git', () => {
            const clone = (0, repo_config_spf_1.getOwnerAndNameFromURL)('https://github.com/withgraphite/graphite-cli');
            (0, chai_1.expect)(clone.owner === 'withgraphite').to.be.true;
            (0, chai_1.expect)(clone.name === 'graphite-cli').to.be.true;
            const sshClone = (0, repo_config_spf_1.getOwnerAndNameFromURL)('git@github.com:withgraphite/graphite-cli');
            (0, chai_1.expect)(sshClone.owner === 'withgraphite').to.be.true;
