...
var survey_config_1 = require("../../config/survey_config");
...
function postSurveyResponse() {
    return __awaiter(this, void 0, void 0, function () {
        var responsePostedSuccessfully;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, survey_config_1["default"].postResponses()];
                case 1:
                    responsePostedSuccessfully = _a.sent();
